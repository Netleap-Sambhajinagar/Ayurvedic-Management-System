...
const PatientData = () => {
  ...
  return (
    <main className="flex-1 bg-gray-50 min-h-screen">
      {/* Top bar */}
      <div className="flex items-center justify-between px-4 sm:px-8 py-4 sm:py-5 bg-white border-b border-gray-100 gap-3">
        <h1 className="text-xl sm:text-2xl font-bold text-gray-800 shrink-0">
          Patients Data
        </h1>
          ...
          {showSearch ? (
            <div className="flex items-center bg-white border rounded-xl px-3 py-2 shadow-sm">
              <input
                ...
                className="outline-none text-sm w-32 sm:w-44 text-gray-700"
                autoFocus
              />
              <button
                onClick={clearSearch}
      ...
      <div className="px-4 sm:px-8 py-4 sm:py-6">
        {loading ? (
          <div className="flex items-center justify-center py-20 text-gray-400">
            <svg
              className="w-5 h-5 animate-spin mr-2 text-green-500"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
